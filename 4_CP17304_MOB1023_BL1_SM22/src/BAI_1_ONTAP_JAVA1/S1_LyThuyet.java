...
public class S1_LyThuyet {
   ...
   2. 4 Tính chất của OOP:
    ...
    /*
    Trong thế giới thực:
        1. Đối tượng:Bàn, Chuột, Bàn Phím, Máy tính, LapTop...Dộng Vật, Chó, Mèo, Cá..... Người, Sinh Viên, Giảng Viên, Người yêu, Người Yêu Cũ....
        2. Thông tin: Miêu tả cho các đối tượng rõ ràng hơn và phân biệt được.
        3. Hành động: Miêu tả hành độ cho đối tượng.
    
    Trong OOP:
        1. Đối tượng: sử dụng tư khoá Class, phải Danh Từ, Viết hoa chữ cái đầu của từ.
        2. Thông tin: Thay đổi tên gọi từ THÔNG TIN => THUỘC TÍNH. Được biểu diễn trong lập trình dưới dạng biến.
        3. Hành động: được mô tả dưới dạng phương thức (Method) và luôn có động từ đứng đằng trước.
    */
}
